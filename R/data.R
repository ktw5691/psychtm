...
#'   \item{rating}{A numerical rating of instructor quality from 1 (worst) to 5 (best)}
#'   \item{grade}{A numerical grade received by the rater for the instructor's course ranging from 1 (worst) to 13 (best)}
#'   \item{doc}{A character vector containing pseudo-written comments about the instructors}
#' }
"teacher_rate"
